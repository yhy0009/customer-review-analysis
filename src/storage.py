"""Backend-neutral persistence contract and compatible SQLite import.

SQLite behavior and schema are implemented only in ``src.sqlite_repository``.
Importing the class from this module keeps existing callers on that same schema.
"""
