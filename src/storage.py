"""Backend-neutral repository contract and compatible SQLite import."""
from __future__ import annotations
from typing import List, Optional, Protocol, Sequence, runtime_checkable
from src.models import (
    AnalysisResult, BatchOperationResult, CleanReview, DuplicatePolicy, Page,
    ProcessingStatus, RawReview, ReviewDetail, ReviewFilter, ReviewQuery, ReviewStatistics,
)
...
# Keep existing callers working while the concrete implementation lives separately.
